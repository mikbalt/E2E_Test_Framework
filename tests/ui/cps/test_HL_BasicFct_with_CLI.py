...
Run:
    pytest tests/ui/cps/test_HL_BasicFct_with_CLI.py -v
    pytest tests/ui/cps/test_HL_BasicFct_with_CLI.py -v --run-id kiwi_run_35 --kiwi-run-id 35
    pytest tests/ui/cps/test_HL_BasicFct_with_CLI.py -v --run-id kiwi_run_35 --kiwi-run-id 35 --alluredir = "C:/Automation/e2e_test_framework/evidence/allure-results"
"""
import logging
...
from tests.schema import TestHsmConfigSchemaHL
...
class TestHLCoverage:
    ...
    @allure.description(
        """
        Scenario: HL Test BasicFct Coverage
        Given eAdmin application is launched and visible.
        And eAdmin is connected to HSM successfully.
        ...
        And User filter the test file into Test_File_Filter
        And User check all available tests
        And User execute selected tests
    ...
    def test_HL_BasicFct_with_CLI(self):
        """Test HL BasicFct."""
        ...
        # ==================================================================
        # Phase 3: TestHSM CLI Configuration for HL Test
        # ==================================================================
        validator = config_validator.ConfigValidator(
            schema_class=TestHsmConfigSchemaHL,
        ...
        config_file = cli_cfg.get("config_HL_windows")
        ...
        try:
            ...
            collector.collect_latest(str(report_dir), name="TestHSM CLI HL Test Report")
