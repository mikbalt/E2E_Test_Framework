"""
Base page object for E-Admin UI automation.

Provides shared helpers: evidence-tracked steps, dialog dismissal,
T&C acceptance, and sidebar navigation.
"""
...
class BasePage:
    """Base class for all E-Admin page objects."""
