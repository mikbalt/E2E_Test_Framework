...
Manual usage:
    metrics = MetricsPusher("http://localhost:9091", job_name="e2e_tests")
...
class MetricsPusher:
    ...
    def __init__(self, pushgateway_url="http://localhost:9091",
                 job_name="e2e_tests", labels=None, run_id=None,
                 metric_prefix="e2e"):
